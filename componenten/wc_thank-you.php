...
<div class="container min-h-[100vh]">
    ...
    <button onclick="window.print()" class="mb-3 w-full text-rcenter underline text-yellow text-14">Klik hier om de factuur te printen</button>
   ...
   <div class="woocommerce-order container pt-6">
	...
	<?php
	if ( $order ) : ?>
 <h1 class="text-60 leading-70 text-black font-typebold pb-3">Factuur</h1>
	<?php 
