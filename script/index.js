const buttonHamburger = document.querySelector(".button-menu");
const mobileNavbarBlock = document.querySelector(".mobile-navbar-block");
const overlay = document.querySelector(".overlay");

buttonHamburger.addEventListener("click", () => {
  buttonHamburger.classList.toggle("open");
  mobileNavbarBlock.classList.toggle("open");
