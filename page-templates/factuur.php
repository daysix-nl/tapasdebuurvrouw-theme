...
<div class="container">
    <div class="">
        <div class="flex justify-end">
            <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="60px" viewBox="0 0 224.806 100.74">
    ...
    <button onclick="window.print()" class="mb-3 w-full text-rcenter underline text-yellow text-10">Klik hier om de pagina te printen</button>
